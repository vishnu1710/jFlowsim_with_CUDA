...
public class MainWindow extends javax.swing.JFrame {
    ...
    private String _solverName, _solverTyp;
    long wait = 30;
...
//        fileToolBar.add(action);
        ...
        for (String solverName : solverKeyList) {
            ...
            for (String testCaseName : testCases) {
                    ...
                    //JMenu solverType = new JMenu(testCaseName);
            
            
            ArrayList<String> solverTypeName = SolverFactory.getInstance().getSolverTyp();
            
            for (String solverTyp : solverTypeName) {
                
                JMenuItem solverType = new JMenuItem(solverTyp);
                // Action Listener
                class CreateSolverAction implements ActionListener {

                    private String solverName;
                    private String testCaseName;
                    private String solverTypName;

                    public CreateSolverAction(String solverName, String testCaseName, String solverTypName) {
                        this.solverName = solverName;
                        this.testCaseName = testCaseName;
                        this.solverTypName = solverTypName;
                    }
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (!modelManager.hasGrid()) {
                            System.out.println("start solver:" + solverName + " \ntestCase:" + testCaseName + "\nSolving on:" + solverTypName);

                            _solverName = solverName;
                            _solverTyp = solverTypName;
                            ...
                            modelManager.startSimulation(solver,_solverTyp);
                ...
                CreateSolverAction listener = new CreateSolverAction(solverName, testCaseName, solverTyp);
                
                
                solverType.addActionListener(listener);
                JMenu testCaseMenuItem = new JMenu(testCaseName);
                testCaseMenuItem.add(solverType);
